...
<tr><td>
    <asp:Label Font-Bold="true" ID="Label1" runat="server" Text="FNAME"></asp:Label></td>
    <td><asp:TextBox ID="fname" runat="server"></asp:TextBox></td></tr>
<tr><td>
    <asp:Label  Font-Bold="true" ID="Label2" runat="server" Text="LNAME"></asp:Label></td>
    <td><asp:TextBox ID="lname" runat="server"></asp:TextBox></td></tr>
<tr><td>
    <asp:Label Font-Bold="true" ID="Label3" runat="server" Text="USERNAME"></asp:Label></td>
    <td><asp:TextBox ID="username" runat="server"></asp:TextBox></td></tr>
<tr><td>
    <asp:Label  Font-Bold="true" ID="Label4" runat="server" Text="PASSWORD"></asp:Label></td>
    <td><asp:TextBox ID="password" runat="server"></asp:TextBox></td></tr>
<tr><td>
    <asp:Label Font-Bold="true" ID="Label5" runat="server" Text="E-MAIL"></asp:Label></td>
    <td><asp:TextBox ID="email" runat="server"></asp:TextBox></td></tr>
<tr><td>
    <asp:Label Font-Bold="true" ID="Label6" runat="server" Text="PHONE NO"></asp:Label></td>
    <td><asp:TextBox ID="phoneno" runat="server"></asp:TextBox></td></tr>
<tr align="center"><td colspan="2">
    <asp:Button Font-Bold="true"  ID="Button1" runat="server" Text="SUBMIT" onclick="Button1_Click" /></td></tr>
</table>
<br /><br /><br /><br />
