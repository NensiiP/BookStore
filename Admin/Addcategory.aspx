...
<HeaderTemplate>
    ...
    <table border="1" width="500" height="300" align="center">
        ...
        <tr><td width="100"><asp:Label ID="Label1" runat="server" Text="Category Name"></asp:Label></td>
            <td class="style1"><asp:TextBox ID="txtcat" runat="server"></asp:TextBox></td></tr>
            <tr><td width="100"><asp:Label ID="txtimg" runat="server" Text="Category Image"></asp:Label></td>
    <td class="style1"><asp:FileUpload ID="FileUpload1" runat="server" Height="28px" /></td></tr>
