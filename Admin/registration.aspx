<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="registration.aspx.cs" Inherits="Admin_Default" Title="Untitled Page" %>
...
<asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
        GridLines="None" DataKeyNames="rid" EmptyDataText="No Data Found" 
        ...
        <AlternatingRowStyle BackColor="White" />
         ...
         <Columns>
             <asp:TemplateField HeaderText="ID"><ItemTemplate><asp:Label ID="Label1" runat="server" Text='<%# Eval("rid") %>'></asp:Label></ItemTemplate></asp:TemplateField>
         ...
         <asp:TemplateField HeaderText="Phoneno"><ItemTemplate><asp:Label ID="Label7" runat="server" Text='<%# Eval("phoneno") %>'></asp:Label></ItemTemplate></asp:TemplateField>    
