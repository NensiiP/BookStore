<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Editcat.aspx.cs" Inherits="Admin_Default" Title="Untitled Page" %>
...
<HeaderTemplate>
    ...
    <table border="1" width="500" height="300" align="center">
        ...
        <tr><td width="100"><asp:Label ID="Label1" runat="server" Text="Category Name"></asp:Label></td>
         ...
         <tr><td width="100"><asp:Label ID="Label6" runat="server" Text="Category Image"></asp:Label></td>
