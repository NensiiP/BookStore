<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Editpro.aspx.cs" Inherits="Admin_Default" Title="Untitled Page" %>
...
<HeaderTemplate>
    ...
    <table border="1" width="500" height="300" align="center">
        <tr><td colspan="2" align="center"><h3>EDIT PRODUCT</h3></td></tr>
        
        <tr><td width="100"><asp:Label ID="Label1" runat="server" Text="Product Name"></asp:Label></td>
            <td><asp:TextBox ID="txtcat" runat="server" Text=""></asp:TextBox></td></tr>
            
         <tr><td width="100"><asp:Label ID="Label2" runat="server" Text="Product Image"></asp:Label></td>
    ...
    <tr><td width="100"><asp:Label ID="Label8" runat="server" Text="id"></asp:Label></td>
